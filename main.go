...
import (
	...
	"github.com/aurelbec/go-fields-updater/models"
	"github.com/aurelbec/go-fields-updater/utils"
)
...
func Usage() {
	_, _ = fmt.Fprintf(os.Stderr, "fields-updater is a tool to generate Go code that adds useful method to update specific fields of specific type.\n")
	_, _ = fmt.Fprintf(os.Stderr, "Usage of %s:\n", os.Args[0])
	_, _ = fmt.Fprintf(os.Stderr, "\tfields-updater [flags] -type T [directory]\n")
	_, _ = fmt.Fprintf(os.Stderr, "\tfields-updater [flags] -type T files... # Must be a single package\n")
	_, _ = fmt.Fprintf(os.Stderr, "For more information, see:\n")
	_, _ = fmt.Fprintf(os.Stderr, "\thttps://github.com/aurelbec/go-fields-updater\n")
...
func main() {
	...
	g.Printf("// Code generated by \"fields-updater %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
